...
#line 83 "./syntax.y"
                                                {(yyval.node) = createNode("VarList","");addNode(3, (yyval.node), (yyvsp[-2].node), %2,(yyvsp[0].node));}
...
#line 1433 "./syntax.tab.c"
  ...
  case 36: /* Stmt: IF LP Exp RP error ELSE Stmt  */
#line 103 "./syntax.y"
                                                {error++;yyerror("Missing \";\".");}
...
#line 1481 "./syntax.tab.c"
  ...
  case 44: /* DecList: Dec error DecList  */
#line 118 "./syntax.y"
                                                {error++;yyerror("DecList error.");}
#line 1487 "./syntax.tab.c"
    break;

  case 45: /* DecList: Dec error  */
#line 119 "./syntax.y"
                                                {error++;yyerror("DecList error.");}
...
#line 1505 "./syntax.tab.c"
  ...
  case 48: /* Dec: VarDec ASSIGNOP error  */
#line 124 "./syntax.y"
